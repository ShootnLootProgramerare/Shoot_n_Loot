...
namespace Shoot__n_Loot
{
    class Item : GameObject
    {
        ...
        {
            spriteBatch.Draw(Sprite.Texture, new Rectangle(position.X, position.Y, position.Width * Properties.Width, position.Height * Properties.Height), null, Color.White, 0, Vector2.Zero, SpriteEffects.None, 0.0000001f);
        }
    }
}
