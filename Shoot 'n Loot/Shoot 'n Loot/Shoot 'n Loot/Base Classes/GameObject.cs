...
namespace Shoot__n_Loot
{
    class GameObject
    {
        ...
        public float Health { get { return health; } set { OnTakeDamage(health - value); health = value; if (health <= 0 && CanDie) { Dead = true; OnDestroy(); if (health > maxHealth) health = maxHealth; } } }
